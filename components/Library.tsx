...
export const Library = ({ templates, onSelect, onAdd, onTogglePin, t, theme }: LibraryProps) => {
  ...
  const TemplateCard = ({ tpl }: { tpl: ContractTemplate }) => (
    <div 
      ...
      <div className={`p-6 md:p-8 flex flex-col flex-1 relative z-20 ${theme === 'dark' ? 'bg-zinc-900' : 'bg-white'}`}>
        <div className="flex justify-between items-start mb-2 md:mb-4">
          ...
          <button 
            ...
            className={`w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center transition-all shrink-0 ${
              tpl.isPinned 
